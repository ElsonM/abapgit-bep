...
DATA(o_splitter_main) = NEW cl_gui_splitter_container(
...
DATA(o_container_o) = o_splitter_main->get_container( row = 1 column = 1 ).
DATA(o_container_u) = o_splitter_main->get_container( row = 2 column = 1 ).
