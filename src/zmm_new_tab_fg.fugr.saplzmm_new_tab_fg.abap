...
*******************************************************************
  INCLUDE LZMM_NEW_TAB_FGTOP.                " Global Declarations
  INCLUDE LZMM_NEW_TAB_FGUXX.                " Function Modules

*******************************************************************
*   User-defined Include-files (if necessary).                    *
*******************************************************************
* INCLUDE LZMM_NEW_TAB_FGF...                " Subroutines
* INCLUDE LZMM_NEW_TAB_FGO...                " PBO-Modules
* INCLUDE LZMM_NEW_TAB_FGI...                " PAI-Modules
* INCLUDE LZMM_NEW_TAB_FGE...                " Events
* INCLUDE LZMM_NEW_TAB_FGP...                " Local class implement.
* INCLUDE LZMM_NEW_TAB_FGT99.                " ABAP Unit tests
