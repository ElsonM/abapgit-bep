...
DATA: lr_document  TYPE REF TO if_ixml_document. "Reference for XML document
DATA: lr_extension TYPE REF TO if_ixml_element.  "Reference for "extension" element in document
DATA: lr_files     TYPE REF TO if_ixml_element.  "Reference for "files" element in document
DATA: lr_media     TYPE REF TO if_ixml_element.  "Reference for "media" element in document
DATA: lr_encoding  TYPE REF TO if_ixml_encoding. "Reference to set encoding
...
DATA file_path TYPE string VALUE '/usr/sap/tmp/manifest.xml'.
