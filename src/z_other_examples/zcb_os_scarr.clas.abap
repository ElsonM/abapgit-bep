...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_OS_SCARR
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_OS_SCARR .
  types:
...
CLASS ZCB_OS_SCARR IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_CARRID TYPE S_CARR_ID
*      RETURNING RESULT TYPE REF TO ZCL_OS_SCARR
************************************************************************
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_OS_SCARR,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-CARRNAME = THE_OBJECT->CARRNAME.
    OBJECT_DATA_ITEM-CURRCODE = THE_OBJECT->CURRCODE.
    OBJECT_DATA_ITEM-URL = THE_OBJECT->URL.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_OS_SCARR.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type SCARR.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_SCARR> type SCARR.
*>
...
*< Generated from mapping:
  select * from SCARR
           ...
           where SCARR~CARRID = I_BUSINESS_KEY_TAB-CARRID.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'SCARR'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_SCARR>.

*< Generated from mapping:
    DB_DATA-CARRID = <FS_DB_SCARR>-CARRID.
    DB_DATA-CARRNAME = <FS_DB_SCARR>-CARRNAME.
    DB_DATA-CURRCODE = <FS_DB_SCARR>-CURRCODE.
    DB_DATA-URL = <FS_DB_SCARR>-URL.
*>
...
* * SCARR: internal tables for mass operation
  data DB_ITB_SCARR type STANDARD TABLE OF SCARR.
  data DB_UTB_SCARR type STANDARD TABLE OF SCARR.
  data DB_DTB_SCARR type STANDARD TABLE OF SCARR.

* * SCARR: headlines for tables
  data DB_ILN_SCARR type SCARR.
  data DB_ULN_SCARR type SCARR.
  data DB_DLN_SCARR type SCARR.
...
*< Generated from mapping:
   ...
   DB_ILN_SCARR-CARRNAME = <FS_INSERT>-CARRNAME.
   DB_ILN_SCARR-CURRCODE = <FS_INSERT>-CURRCODE.
   DB_ILN_SCARR-URL = <FS_INSERT>-URL.


   DB_ILN_SCARR-CARRID = <FS_INSERT>-CARRID.
   append DB_ILN_SCARR to DB_ITB_SCARR.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_SCARR-CARRNAME = <FS_UPDATE>-CARRNAME.
   DB_ULN_SCARR-CURRCODE = <FS_UPDATE>-CURRCODE.
   DB_ULN_SCARR-URL = <FS_UPDATE>-URL.


   DB_ULN_SCARR-CARRID = <FS_UPDATE>-CARRID.
   append DB_ULN_SCARR TO DB_UTB_SCARR.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_SCARR-CARRID = <FS_DELETE>-BUSINESS_KEY-CARRID.

    append DB_DLN_SCARR TO DB_DTB_SCARR.
...
* * DB Deletes
  delete SCARR FROM TABLE DB_DTB_SCARR.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert SCARR FROM TABLE DB_ITB_SCARR
...
* * DB Updates
  update SCARR FROM TABLE DB_UTB_SCARR.
  if SY-SUBRC <> 0.
...
*<  Generated from mapping:
  ...
  THE_OBJECT->CARRNAME = I_OBJECT_DATA-CARRNAME.
  THE_OBJECT->CURRCODE = I_OBJECT_DATA-CURRCODE.
  THE_OBJECT->URL = I_OBJECT_DATA-URL.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_OS_SCARR.
