...
DATA: it_ekko TYPE TABLE OF ty_ekko,
      it_ekpo TYPE TABLE OF ty_ekpo,    "Internal tables

      wa_ekko TYPE ty_ekko,

      wa_fcat TYPE slis_fieldcat_alv,
      it_fcat TYPE slis_t_fieldcat_alv, "Field catalog work area & tables

      wa_layout TYPE slis_layout_alv,   "ALV layout work area

      wa_key TYPE slis_keyinfo_alv.     "Key information for hierarchical list
